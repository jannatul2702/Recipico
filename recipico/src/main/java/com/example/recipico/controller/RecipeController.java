...
public class RecipeController {
    ...
    @GetMapping("/recipes")
    public List<RecipeResponse> findAllRecipes(@RequestParam(required = false) Category category,
    @RequestParam(required = false) RecipeType type,
    @RequestParam(required = false) Difficulty difficulty,
    @RequestParam(required = false) Integer prepTime) {
        final List<RecipeResponse> recipes = recipeService.findAllRecipes(category, type, difficulty, prepTime);
